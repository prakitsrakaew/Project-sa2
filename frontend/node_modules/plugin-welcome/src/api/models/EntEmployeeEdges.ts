...
export function EntEmployeeEdgesFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntEmployeeEdges {
    ...
    return {
        ...
        'employees': !exists(json, 'employees') ? undefined : ((json['employees'] as Array<any>).map(EntBillFromJSON)),
    };
}
...
export function EntEmployeeEdgesToJSON(value?: EntEmployeeEdges | null): any {
    ...
    return {
        ...
        'employees': value.employees === undefined ? undefined : ((value.employees as Array<any>).map(EntBillToJSON)),
    };
}
