...
func (rq *RepairinvoiceQuery) QueryRepairinvoices() *BillQuery {
	query := &BillQuery{config: rq.config}
...
func (rq *RepairinvoiceQuery) WithRepairinvoices(opts ...func(*BillQuery)) *RepairinvoiceQuery {
	query := &BillQuery{config: rq.config}
