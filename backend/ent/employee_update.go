...
// AddEmployees adds the employees edges to Bill.
func (eu *EmployeeUpdate) AddEmployees(b ...*Bill) *EmployeeUpdate {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
// RemoveEmployees removes employees edges to Bill.
func (eu *EmployeeUpdate) RemoveEmployees(b ...*Bill) *EmployeeUpdate {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
// AddEmployees adds the employees edges to Bill.
func (euo *EmployeeUpdateOne) AddEmployees(b ...*Bill) *EmployeeUpdateOne {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
...
// RemoveEmployees removes employees edges to Bill.
func (euo *EmployeeUpdateOne) RemoveEmployees(b ...*Bill) *EmployeeUpdateOne {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
